                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            href="delete.php?id=<?=htmlspecialchars(trim($row['id']))?>"
                             style="color:white">Delete</a><a class="float-right">&nbsp;</a>
                            <a class="btn btn-sm btn-primary float-right" name="edit" style="color:white" onclick=edit(this)>Edit</a>
                        </div>
                        <div class="card-body">
                            <textarea class="form-control clip-card" name="clip" id="" placeholder="A New Clip" readonly><?=htmlspecialchars(trim($row['clip']))?></textarea><br>
